    ...
    <section id="blog" className="px-6 py-12 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {blogs.map((blog) => (
            <article key={blog.id} className="flex flex-col rounded-[24px] bg-white p-5 shadow-lg shadow-black/5 ring-1 ring-black/5 sm:rounded-[30px] sm:p-7 lg:p-8">
              ...
              <h3 className="mt-4 font-display text-2xl font-semibold text-[#1A1208] sm:text-3xl">{blog.title}</h3>
